...
public class CustomBiayaAdapter extends ArrayAdapter<DetailBiayaItem> {
    public CustomBiayaAdapter(Context context, ArrayList<DetailBiayaItem> detailBiayaItems) {
        super(context, 0, detailBiayaItems);
     }
     ...
     public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
         ...
         DetailBiayaItem detailBiayaItem = getItem(position);
        ...
        tvRBA.setText(detailBiayaItem.getRBA());
        tvVolume.setText(detailBiayaItem.getVolume());
        tvHarga.setText(detailBiayaItem.getHarga());
        tvTotal.setText(detailBiayaItem.getTotal());
